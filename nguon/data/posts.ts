...
export const posts: Post[] = [
  {
    ...
    body: [
      ...
      "Tôi không viết mỗi ngày. Có tuần chỉ được vài dòng. Mực Lặng tồn tại vì vậy — để những gì đáng nhớ không bị ép thành khuôn đều đặn. Một bài ra đời khi nó chịu ra, không phải khi lịch nhắc.",
  ...
  },
  {
    ...
    body: [
      ...
      "Chọn font là chọn tốc độ. Một tiêu đề Grotesk lớn nói: nhìn đây, mau. Một tiêu đề serif vừa phải nói: vào đây, ở lại. Mực Lặng chọn cái sau — không vì cũ, vì hợp với việc viết chậm.",
